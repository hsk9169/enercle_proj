...
class MypageChangePasswordView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _MypageChangePasswordView();
}

class _MypageChangePasswordView extends State<MypageChangePasswordView> {
  ...
  Widget _renderEditor() {
    final String curPassword = Provider.of<Platform>(context, listen: false).pw;
    return Container(
        width: context.pWidth,
